...
public class DemoScene1 extends Scene {
    ...
    @Override
    public void onEnter() {
        inputManager.addInputSource(bucketPlayerId, new KeyboardArrowInputSource());
        ...
        float bucketW = 64f; float bucketH = 64f;
        float bucketX = (screenW - bucketW) / 2f; float bucketY = 20f;
        ...
        for (int i = 0; i < 10; i++) {
            ...
            Droplet droplet = new Droplet(
                    "droplet.png", dropX, dropY + i * 60f, dropW, dropH,
