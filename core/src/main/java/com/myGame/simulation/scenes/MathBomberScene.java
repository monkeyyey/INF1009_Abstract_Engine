...
public class MathBomberScene extends Scene {
    ...
    public MathBomberScene(InputManager inputManager,
        ...
        this(inputManager, audioManager, entityManager, collisionManager, movementManager, config, controlScheme, questionMode, onGameWon,
    ...
    private void spawnQuestionEnemies() {
        List<Integer> values = questionGenerator.buildEnemyValues(currentQuestion.getAnswer(), config.enemyCount);
