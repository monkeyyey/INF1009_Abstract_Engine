...
public class StartMenuScene extends StaticScene {
    ...
    private void buildUi() {
        ...
        float row3Y = h * 0.38f - 40f;
        float startY = h * 0.16f - 40f;
        ...
        volumeSlider = new VolumeSlider((w - sliderW) / 2f, h * 0.27f - 40f, sliderW, 18f, Color.DARK_GRAY, Color.SKY, currentMenuVolume());
