...
public final class CollisionDetector {
    ...
    private static boolean checkCircleCircle(CircleHitbox a, float ax, float ay,
    ...
    private static boolean checkRectRect(RectHitbox a, float ax, float ay,
    ...
    private static boolean checkCircleRect(CircleHitbox circle, float cx, float cy,
